...
public class GetPositionActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener  {
        ...
        dialog.setTitle("Activer votre localisation")
                ...
                .setNegativeButton("Annuler", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                        ...
                        Toast.makeText(GetPositionActivity.this,"localisation impossible",Toast.LENGTH_SHORT).show();
                    }
                });
